...
template<class TV> OTHER_CORE_EXPORT PyObject* to_python(const Segment<TV>& seg);
...
template<class TV> OTHER_CORE_EXPORT real interpolation_fraction(const Segment<TV>& s, const TV p);
template<class TV> OTHER_CORE_EXPORT real clamped_interpolation_fraction(const Segment<TV>& s, const TV p);
...
template<int d> OTHER_CORE_EXPORT real segment_point_distance(Segment<Vector<real,d>> s, Vector<real,d> p);

// Snap a point to the closest point on a segment, and return (closest,weight).
template<int d> OTHER_CORE_EXPORT Tuple<Vector<real,d>,real> segment_closest_point(Segment<Vector<real,d>> s, Vector<real,d> p);
...
template<int d> OTHER_CORE_EXPORT Tuple<real,Vector<real,d>,real> segment_point_distance_and_normal(Segment<Vector<real,d>> s, Vector<real,d> p);

/********* Segment / Segment *********/

template<int d> OTHER_CORE_EXPORT real segment_segment_distance(Segment<Vector<real,d>> s0, Segment<Vector<real,d>> s1);
...
template<int d> OTHER_CORE_EXPORT Tuple<real,Vector<real,3>,Vector<real,2>> segment_segment_distance_and_normal(Segment<Vector<real,d>> s0, Segment<Vector<real,d>> s1);

/********* Segment / Ray *********/

// Segment is lengthened at each end by half_thickness
OTHER_CORE_EXPORT bool segment_ray_intersection(const Segment<Vector<real,2>>& seg, Ray<Vector<real,2>>& ray, const real half_thickness);

/********* Point / Line *********/

template<int d> OTHER_CORE_EXPORT real line_point_distance(Segment<Vector<real,d>> s, Vector<real,d> p);

template<int d> OTHER_CORE_EXPORT Tuple<Vector<real,d>,real> line_closest_point(Segment<Vector<real,d>> s, Vector<real,d> p);

// Distance,normal,weight
OTHER_CORE_EXPORT Tuple<real,Vector<real,3>,real> line_point_distance_and_normal(Segment<Vector<real,3>> s, Vector<real,3> p);
...
OTHER_CORE_EXPORT Tuple<real,Vector<real,3>,Vector<real,2>> line_line_distance_and_normal(Segment<Vector<real,3>> s0, Segment<Vector<real,3>> s1);
