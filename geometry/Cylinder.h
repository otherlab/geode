...
public:
  ...
  Cylinder(TV x0, TV x1, T radius) OTHER_CORE_EXPORT;
...
ostream& operator<<(ostream& output, const Cylinder& cylinder) OTHER_CORE_EXPORT;
PyObject* to_python(const Cylinder& cylinder) OTHER_CORE_EXPORT;
