...
void debug_print_single(const char* prefix) OTHER_EXPORT;
void debug_print_msg(const char* prefix, const char* msg) OTHER_EXPORT;
void debug_print_helper(const char* prefix,...) OTHER_EXPORT;
void debug_print_helper_multiline(const char* prefix,...) OTHER_EXPORT;
