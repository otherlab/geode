...
#define NESTED_CONVERSIONS_HELPER(...) \
  template OTHER_CORE_EXPORT PyObject* to_python<__VA_ARGS__>(const Nested<__VA_ARGS__>&); \
  template OTHER_CORE_EXPORT Nested<__VA_ARGS__> FromPython<Nested<__VA_ARGS__>>::convert(PyObject*);
