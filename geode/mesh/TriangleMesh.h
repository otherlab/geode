...
protected:
GEODE_CORE_EXPORT TriangleMesh(Array<const Vector<int,3> > elements);
public:
  ~TriangleMesh();
  ...
  GEODE_CORE_EXPORT Ref<const SegmentMesh> segment_mesh() const;
  ...
  GEODE_CORE_EXPORT Ref<SegmentMesh> boundary_mesh() const;
