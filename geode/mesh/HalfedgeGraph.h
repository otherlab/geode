...
public:
  ...
  GEODE_CORE_EXPORT EdgeId add_edge(const VertexId v0, const VertexId v1);
  ...
  // GEODE_CORE_EXPORT Tuple<VertexId, EdgeId, EdgeId> add_intersection(const EdgeId e0, const EdgeId e1);
