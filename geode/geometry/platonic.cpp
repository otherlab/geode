...
Tuple<Ref<TriangleSoup>,Array<TV>> octahedron_mesh() {
  // Generated by gen-platonic
  static const IV tris[] = {IV(5,3,1),IV(1,3,4),IV(1,2,5),IV(4,2,1),IV(0,3,5),IV(4,3,0),IV(5,2,0),IV(0,2,4)};
  static const TV X[] = {TV(1,0,0),TV(-1,0,0),TV(0,1,0),TV(0,-1,0),TV(0,0,1),TV(0,0,-1)};
  return tuple(new_<TriangleSoup>(frozen_copy(asarray(tris))),asarray(X).copy());
}
