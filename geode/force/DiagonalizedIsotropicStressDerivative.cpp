...
template<class T> void DiagonalizedIsotropicStressDerivative<T,2>::enforce_definiteness() {
...
template<class T> void DiagonalizedIsotropicStressDerivative<T,3,2>::enforce_definiteness() {
  A.enforce_definiteness();
  x2020 = max(x2020,(T)0);
  x2121 = max(x2121,(T)0);
}

template<class T> void DiagonalizedIsotropicStressDerivative<T,3>::enforce_definiteness(const T eigenvalue_clamp_percentage,const T epsilon) {
