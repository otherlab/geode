...
struct Vertex {
  ...
  static Quantized tolerance() { return 1; }
  ...
  GEODE_UNUSED friend ostream& operator<<(ostream& output, const Vertex v) {
...
GEODE_CORE_EXPORT bool circles_intersect(Arcs arcs, const int arc0, const int arc1);
