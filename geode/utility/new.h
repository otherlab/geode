// new_: Create a reference counted object
//
// new_<T>(args...) creates an object and returns it as a Ref<T>.  T must inherit
// from Object.  This unified creation ensures that all instances of Object are
// reference counted.
#pragma once
