...
GEODE_DECLARE_VECTOR_CONVERSIONS(GEODE_CORE_EXPORT,1,real)
GEODE_DECLARE_VECTOR_CONVERSIONS(GEODE_CORE_EXPORT,2,real)
GEODE_DECLARE_VECTOR_CONVERSIONS(GEODE_CORE_EXPORT,3,real)
GEODE_DECLARE_VECTOR_CONVERSIONS(GEODE_CORE_EXPORT,4,real)
