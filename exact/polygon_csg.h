...
OTHER_CORE_EXPORT Nested<Vec2> split_polygons(Nested<const Vec2> polys, const int depth);
OTHER_CORE_EXPORT Nested<exact::Vec2> exact_split_polygons(Nested<const exact::Vec2> polys, const int depth);
