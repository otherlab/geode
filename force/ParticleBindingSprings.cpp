...
//#####################################################################
#include <other/core/force/ParticleBindingSprings.h>
...
OTHER_DEFINE_TYPE(ParticleBindingSprings)
...
void wrap_particle_binding_springs() {
  ...
  Class<Self>("ParticleBindingSprings")
    .OTHER_INIT(Array<const Vector<int,2>>,Array<const T>,NdArray<const T>,NdArray<const T>)
    ;
}
