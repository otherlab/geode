...
if env['cxx']=='<detect>':
  if windows:
    ...
    for gcc in 'clang++-3.6 clang++ g++-4.7 g++-4.6 g++'.split():
...
if clang:
  env.Append(CXXFLAGS=' -Wno-array-bounds -Wno-unknown-pragmas -Wno-deprecated -Wno-format-security') # for Python and OpenMP, respectively
