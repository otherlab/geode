...
public:
  ...
  // Copy the mesh
  OTHER_CORE_EXPORT Ref<TriangleTopology> copy() const;
  ...
  OTHER_CORE_EXPORT VertexId add_vertices(int n);
  ...
  OTHER_CORE_EXPORT void erase(VertexId id, bool erase_isolated = false);
  ...
  OTHER_CORE_EXPORT void erase(HalfedgeId id, bool erase_isolated = false);

  // Erase the given face. If erase_isolated is true, also erases incident vertices that are now isolated.
  OTHER_CORE_EXPORT void erase(FaceId id, bool erase_isolated = false);
  ...
  OTHER_CORE_EXPORT void erase_face_with_reordering(FaceId f);
  ...
  OTHER_CORE_EXPORT void erase_last_vertex_with_reordering();
};
