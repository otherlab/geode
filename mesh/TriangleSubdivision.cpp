...
template OTHER_CORE_EXPORT Array<T> TriangleSubdivision::linear_subdivide(RawArray<const T>) const;
template OTHER_CORE_EXPORT Array<Vector<T,2> > TriangleSubdivision::linear_subdivide(RawArray<const Vector<T,2> >) const;
template OTHER_CORE_EXPORT Array<Vector<T,3> > TriangleSubdivision::linear_subdivide(RawArray<const Vector<T,3> >) const;
template OTHER_CORE_EXPORT Array<Vector<T,4> > TriangleSubdivision::linear_subdivide(RawArray<const Vector<T,4> >) const;
