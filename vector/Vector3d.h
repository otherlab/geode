...
public:
    ...
    T min() const
    {return other::min(x,y,z);}

    T max() const
    {return other::max(x,y,z);}

    T maxabs() const
    {return other::maxabs(x,y,z);}

    int argmin() const
    {return other::argmin(x,y,z);}

    int argmax() const
    {return other::argmax(x,y,z);}
    ...
    {return Vector(other::max(v1.x,v2.x),other::max(v1.y,v2.y),other::max(v1.z,v2.z));}
