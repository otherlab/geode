...
//#####################################################################
    ...
    void fast_singular_value_decomposition(Matrix<T,3>& U,DiagonalMatrix<T,3>& singular_values,Matrix<T,3>& V) const OTHER_CORE_EXPORT;
    void fast_indefinite_polar_decomposition(Matrix<T,3>& Q,SymmetricMatrix<T,3>& S) const OTHER_CORE_EXPORT;
    T simplex_minimum_altitude() const OTHER_CORE_EXPORT;
//#####################################################################
};
// global functions
template<class T>
