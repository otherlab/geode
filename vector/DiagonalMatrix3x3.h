...
public:
    ...
    T min() const
    {return other::min(x00,x11,x22);}

    T max() const
    {return other::max(x00,x11,x22);}

    T minabs() const
    {return other::minabs(x00,x11,x22);}

    T maxabs() const
    {return other::maxabs(x00,x11,x22);}
    ...
    {return DiagonalMatrix(other::sqrt(x00),other::sqrt(x11),other::sqrt(x22));}

    DiagonalMatrix clamp_min(const T a) const
    {return DiagonalMatrix(other::clamp_min(x00,a),other::clamp_min(x11,a),other::clamp_min(x22,a));}

    DiagonalMatrix clamp_max(const T a) const
    {return DiagonalMatrix(other::clamp_max(x00,a),other::clamp_max(x11,a),other::clamp_max(x22,a));}

    DiagonalMatrix abs() const
    {return DiagonalMatrix(other::abs(x00),other::abs(x11),other::abs(x22));}

    DiagonalMatrix sign() const
    {return DiagonalMatrix(other::sign(x00),other::sign(x11),other::sign(x22));}
