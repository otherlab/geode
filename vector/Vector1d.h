...
public:
    ...
    Vector()
        :x()
    {
        BOOST_STATIC_ASSERT(sizeof(Vector)==sizeof(T));
    }
    ...
    {return Vector(other::min(v1.x,v2.x));}
    ...
    {BOOST_STATIC_ASSERT((mpl::and_<mpl::less_equal<mpl::int_<0>,mpl::int_<d1> >,mpl::less_equal<mpl::int_<d2>,mpl::int_<1> > >::value));
