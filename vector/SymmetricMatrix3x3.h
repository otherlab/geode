...
//#####################################################################
    ...
    OTHER_CORE_EXPORT DiagonalMatrix<T,3> fast_eigenvalues() const ;
    OTHER_CORE_EXPORT void fast_solve_eigenproblem(DiagonalMatrix<T,3>& eigenvalues,Matrix<T,3>& eigenvectors) const ;
