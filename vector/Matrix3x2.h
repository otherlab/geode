...
//#####################################################################
    void fast_singular_value_decomposition(Matrix& U,DiagonalMatrix<T,2>& singular_values,Matrix<T,2>& V) const OTHER_EXPORT;
    void fast_indefinite_polar_decomposition(Matrix<T,3,2>& Q,SymmetricMatrix<T,2>& S) const OTHER_EXPORT;
//#####################################################################
};
